...
docker rmi -f petrjahoda/linaplast_userimport:2020.3.3
docker build -t petrjahoda/linaplast_userimport:2020.3.3 .
docker push petrjahoda/linaplast_userimport:2020.3.3
